  ...
  <li>
    ...
    background: currentColor; font:inherit">
        ...
        <a href="suppliers.jsp">Supplier Details</a>
           ...
           <section>
               <h2 style="font-family: comic sans; text-align: center ; color: #666666">Books</h2>
    <br><br>
        <input type="text" class="table-fields" id="myInput" onkeyup="myFunction()" placeholder="Search by Book Id" title="Type in a name">
       <input type="text" class="table-fields" id="myInput2" onkeyup="myFunction2()" placeholder="Search by Title" title="Type in a name">
       <br><br>
    ...
    <%
        ...
        while(rs.next())
        {
            ...
            <tr>
                ...
                <td><% out.println(rs.getString("edition_year")); %></td>
                <td><% out.println(rs.getString("publisher")); %></td>
                <td><% out.println(rs.getString("publication_year")); %></td>
