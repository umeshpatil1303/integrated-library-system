...
<header><i class="glyphicon glyphicon-user" style="font-size: 20px"></i>
  ...
  <li>
    ...
    background: currentColor; font:inherit">
        ...
        <a class="active" href="notification.jsp">View Notifications</a>
  ...
  <li>
    ...
    background: currentColor; font:inherit">
        ...
        <a href="suppliers.jsp">Supplier Details</a>
               ...
               <section>
        <h2 style="font-family: comic sans; text-align: center ; color: #666666">Student Queries</h2>
        <br><br>
    ...
    <%
        rs = st.executeQuery("select * from adminnotification;");
        while(rs.next())
        {
            %>
            <tr class="header">
                <td><% out.println(rs.getString("notidate")); %></td>
