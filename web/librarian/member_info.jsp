...
<html>
<head><title>Member Details</title>
...
<header><i class="glyphicon glyphicon-user" style="font-size: 20px"></i>
  ...
  <li>
    ...
    background: currentColor; font:inherit">
          <a class="active" href="member_info.jsp">Student Details</a>
  ...
  <li><a href="report.jsp">Reports</a></li>
    ...
    <h2 style="font-family: comic sans; text-align: center ; color: #666666">Students</h2>
        <input type="text" class="table-fields" id="myInput" onkeyup="myFunction()" placeholder="Search by Enrollment No.." title="Type in a name">
       ...
       <table id="myTable" class="table table-hover" style="max-width: inherit; width: 140%">
           <thead>
            ...
            <th>Email</th>
            <th>Address</th>
            <th>Fine Due</th></thead>
    <%
        rs = st.executeQuery("select * from studentprofile;");
        while(rs.next())
        {
            %>
            <tr>
